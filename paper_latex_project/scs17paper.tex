...
\textbf{Keywords:} UAV simulation, Delivery optimization, agent-based modelling, Smart City, Swarm optimization
%% AUTHOR:
...
\textbf{\uppercase{Jan Gerald Huenges}} is a master student of Management Information Systems at TU Berlin, graduated his bachelor's at the same university. He concentrates on software engineering and Health care. His email address is \email{jan.g.huenges@campus.tu-berlin.de}.

\textbf{\uppercase{Aleksandra Pranskaityte}} is a master student of Management Information Systems at TU Berlin.  Her email address is \email{a.pranskaityte@campus.tu-berlin.de}.
