...
class CommunicationModule_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.comm_module = CommunicationModule(perceived_world=self.uav2.perceived_world,model=self.model,
                                               max_altitude=3)
    ...
    def test_init(self):
        ...
        self.assertIs(self.comm_module.model, self.model)
