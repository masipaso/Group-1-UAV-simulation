...
class WorldModelTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.model.range_of_base_station,config.getfloat('Base_station', 'range_of_base_station', fallback=125))
        self.assertEqual(self.model.number_of_uavs_per_base_station,config.getint('UAV', 'number_of_uavs_per_base_station', fallback=2))
