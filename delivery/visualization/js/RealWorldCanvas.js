var RealWorldCanvas = function(canvas_width, canvas_height, grid_width, grid_height) {
    ...
    // ------------------------
    // Create the tag
    var backgroundCanvasTag = "<canvas class='background' width='" + canvas_width + "' height='" + canvas_height + "' ";
    backgroundCanvasTag += "style=''></canvas>";
    ...
    // ------------------------
	// Create the tag
	var foregroundCanvasTag = "<canvas class='real-world' width='" + canvas_width + "' height='" + canvas_height + "' ";
	foregroundCanvasTag += "style=''></canvas>";
	// Append it to body
